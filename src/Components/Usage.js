...
const Usage = () => {
  ...
  return (
    <div className='modal'>
      ...
      <h1>
        <center><span aria-label="Emoji" role='img'>📘</span> Curriculum Authoring Tool</center>
      </h1>
      <h4>
        <center>
          <span aria-label="Emoji" role='img'>✨ </span>This can be mainly used to design the
          Syllabus or Curriculum for schools, colleges and elsewhere
        </center>
      </h4>
      <hr></hr>
      <p>
        <span aria-label="Emoji" role='img'>✅ </span>You can create Topics and Subtopics. Add
        text, indent, outdent, move and delete rows.
      </p>
      <p>
        <span aria-label="Emoji" role='img'>✅ </span>You can import and export as a json file
      </p>
      <ul>
